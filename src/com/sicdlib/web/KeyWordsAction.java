...
//		PropertyFilter filters = new PropertyFilter("kw_name", kw_name);
//		List<KeyWords> keywords = keyService.search(filters);
...
//		最后真实用的数据：
//		List<KeyWords> keywords = keyService.getSpecificKeyWords(kw_name, df.format(date));
		List<KeyWords> keywords = keyService.getSpecificKeyWords(kw_name, "2016-07-26");
