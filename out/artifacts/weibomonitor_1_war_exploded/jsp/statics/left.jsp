<%@ page language="java" import="java.util.*,com.sicdlib.dto.User"  pageEncoding="UTF-8"%>
         ...
         <%-- <ul id="nav">
           ...
           <ul id="nav">
              <c:forEach items="${menuList}" var="menu"  >
                <li><a href="<%=basePath%>${menu.m_url}" class="active"><i class="fa fa-${menu.m_icon} fa-fw"></i>${menu.m_name}</a></li>
              </c:forEach>
           </ul>
        </nav>
