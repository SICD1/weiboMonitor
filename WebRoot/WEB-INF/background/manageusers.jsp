...
<div class="templatemo-flex-row">
    ...
    <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="pagination-wrap">
            <ul class="pagination">
                <li><a href="background/manageusers?pageNo=1">1</a></li>
                <li><a href="background/manageusers?pageNo=2">2</a></li>
                <li><a href="background/manageusers?pageNo=3">3 <span class="sr-only">(current)</span></a></li>
                <li><a href="background/manageusers?pageNo=4">4</a></li>
                <li><a href="background/manageusers?pageNo=5">5</a></li>
                <li>
                    <a href="background/manageusers?pageNo=${page.nextPage+1}" aria-label="Next">
